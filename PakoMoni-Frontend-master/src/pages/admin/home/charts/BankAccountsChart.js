...
const BankAccountsChart = ({chartData}) => {
    const titleComponent = () => <div className="font-size-md mb-4 text-center w-100">Monthly chart of bank accounts</div>;
...
BankAccountsChart.propTypes = {
    chartData: PropTypes.array
};

export default pure(BankAccountsChart);
